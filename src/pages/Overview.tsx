...
const Overview = () => {
  ...
  const stats = [
    { label: "Sites", value: sites?.length || 0, sub: `${readySites} active`, icon: Globe, color: "text-primary" },
  ...
  return (
    <div className="p-6 lg:p-8 max-w-7xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-sm text-muted-foreground mt-1">Your AI commerce dashboard at a glance</p>
      </div>
      ...
      <Card>
        ...
        <CardContent>
          {!orders?.length ? (
            <p className="text-sm text-muted-foreground py-4 text-center">No orders yet. Orders will appear when customers purchase through the chat widget.</p>
          ) : (
